...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--input_json', type=str, default='data/all_videodatainfo_2017.json',
                        help='msr_vtt videoinfo json')
    parser.add_argument('--info_json', default='data/all_info.json',
                        help='info about iw2word and word2ix')
    parser.add_argument('--caption_json', default='data/all_caption.json', help='caption json file')
